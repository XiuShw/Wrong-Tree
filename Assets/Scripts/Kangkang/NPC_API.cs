...
包括：
1. 设置NPC状态 `SetNPCState(NPCState newState)`
...
It includes:
1. Set NPC state: `SetNPCState(NPCState newState)`
...
public class NPC_API : MonoBehaviour
{
	...
	static NPCState prevStateBeforeNarrative;
	...
	public void EnableNarrative()
	{
		...
		npc.SetState(NPCState.Narrative);
	}
	...
	public void DisableNarrative(bool restorePrev = true)
	{
		...
		if (restorePrev && npc.currentState == NPCState.Narrative)
		{
